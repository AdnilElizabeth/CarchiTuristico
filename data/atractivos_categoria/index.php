				...
				<div class="main-content-inner">
				 <div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Catergoría de Atractivos Turisticos </li>
						</ul><!-- /.breadcrumb -->
							...
							<div class="col-xs-6">
								...
								<div class="widget-box">
									<div class="widget-header">
										<h5 class="widget-title">Catergoría de Atractivos Turisticos</h5>
										...
										<div class="widget-main">
											...
											<form class="form-horizontal" id="form-guardar">
												<div class="form-group">
													<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="email">Categoría:</label>
					...
					<div class="modal-content">
						<div class="modal-header no-padding">
							<div class="table-header">
								...
								Actualizar Categoría de Atractivos
							</div>
						</div>
						<div class="modal-body padding">
							<div class="profile-user-info profile-user-info-striped">
								<input type="hidden" id="txt_id_atractivos_categoria">
