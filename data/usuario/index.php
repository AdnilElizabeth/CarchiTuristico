							...
							<div class="col-xs-6">
								...
								<div class="widget-box">
									<div class="widget-header">
										<h5 class="widget-title">Usuario</h5>
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<form class="form-horizontal" id="form-guardar">
												...
												<div class="form-group">
													<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="email">Nombre de usuario:</label>

													<div class="col-xs-12 col-sm-9">
														<div class="clearfix">
															<input type="text" name="txt_user" id="txt_user" style='text-transform:uppercase;' class="col-xs-12 col-sm-10">
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="state">Tipo de Usuario:</label>
												...
												<div class="form-group">
													<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="email">Clave:</label>

													<div class="col-xs-12 col-sm-9">
														<div class="clearfix">
															<input type="password" name="txt_clave" id="txt_clave" style='text-transform:uppercase;' class="col-xs-12 col-sm-10">
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="email">Confirmar clave:</label>

													<div class="col-xs-12 col-sm-9">
														<div class="clearfix">
															<input type="password" name="txt_clave1" id="txt_clave1" style='text-transform:uppercase;' class="col-xs-12 col-sm-10">
														</div>
													</div>
												</div>
												<div class="form-group">
							...
							<div class="profile-user-info profile-user-info-striped">
								<input type="hidden" id="txt_id_usuario">
									...
									<div class="profile-info-row">
											...
											<div class="profile-info-value" >
												<span class="editable" id="lbl_nombre_user">..</span>
											</div>
									</div>
									<div class="profile-info-row">
											<div class="profile-info-name"> Tipo de usuario: </div>
											<div class="profile-info-value">
												<span class="editable" id="select_user">Tipo usuario</span>
											</div>
									</div>
									<div class="profile-info-row">
											<div class="profile-info-name"> Clave: </div>
											<div class="profile-info-value" >
												<span class="editable" id="lbl_clave">..</span>
											</div>
									</div>
									<div class="profile-info-row">
